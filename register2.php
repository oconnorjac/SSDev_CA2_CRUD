...
<h1 class="pageTitle">Register</h1>
        <form action="register_customer.php" method="post" enctype="multipart/form-data"
            ...
            <input type="input" name="customerID" id="customerID" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required onkeypress="custid_validation();">
            ...
            <input type="input" name="mobile" id="mobile" pattern="[0][8][3,5-9][0-9]{7}" required onkeypress="mobileNum_valdation()">
